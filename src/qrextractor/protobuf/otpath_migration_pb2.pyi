...
class Payload(_message.Message):
    ...
    class OtpParameters(_message.Message):
        ...
        def __init__(
            self,
            secret: _Optional[bytes] = ...,
            name: _Optional[str] = ...,
            issuer: _Optional[str] = ...,
            algorithm: _Optional[_Union[Payload.Algorithm, str]] = ...,
            digits: _Optional[_Union[Payload.DigitCount, str]] = ...,
            type: _Optional[_Union[Payload.OtpType, str]] = ...,
    ...
    def __init__(
        self,
        otp_parameters: _Optional[
            _Iterable[_Union[Payload.OtpParameters, _Mapping]]
        ] = ...,
        version: _Optional[int] = ...,
        batch_size: _Optional[int] = ...,
        batch_index: _Optional[int] = ...,
